          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div
                ...
                style="background: url(https://images.unsplash.com/photo-1549590143-d5855148a9d5?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80) center no-repeat ;   background-size: cover;"
              ></div>
              <div class="col-lg-6">
                <div class="p-5">
